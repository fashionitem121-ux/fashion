...
const PRODUCTS = [
  {
    ...
    images: [], // add at least 4 image URLs here
    description: [
  ...
  { id: "p2", name: "Product Name 2", price: 0, rating: 4.2, reviews: 8,  topSale: true,  inStock: true, image: "", images: [], description: [], reviews: [] },
  { id: "p3", name: "Product Name 3", price: 0, rating: 4.8, reviews: 21, topSale: false, inStock: true, image: "", images: [], description: [], reviews: [] },
  { id: "p4", name: "Product Name 4", price: 0, rating: 4.0, reviews: 5,  topSale: false, inStock: true, image: "", images: [], description: [], reviews: [] },
  { id: "p5", name: "Product Name 5", price: 0, rating: 4.6, reviews: 14, topSale: false, inStock: true, image: "", images: [], description: [], reviews: [] },
  { id: "p6", name: "Product Name 6", price: 0, rating: 4.3, reviews: 9,  topSale: false, inStock: true, image: "", images: [], description: [], reviews: [] },
  { id: "p7", name: "Product Name 7", price: 0, rating: 4.7, reviews: 17, topSale: false, inStock: true, image: "", images: [], description: [], reviews: [] },
  { id: "p8", name: "Product Name 8", price: 0, rating: 4.1, reviews: 6,  topSale: false, inStock: true, image: "", images: [], description: [], reviews: [] }
];
